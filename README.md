...
- [Download from Github](https://github.com/Gourav047/Vroom_Demo.git).
- [Download from Creative Tim](https://github.com/Gourav047/Vroom_Demo.git).
- Clone the repo: `git clone https://github.com/Gourav047/Vroom_Demo.git`.
...
1. Make sure that you are using the latest version of the Paper Kit 2 Angular.
2. Providing us reproducible steps for the issue will shorten the time it takes for it to be fixed.
3. Some issues may be browser specific, so specifying in what browser you encountered the issue might help.

## Technical Support or Questions

If you have questions or need help integrating the product please instead of opening an issue.
